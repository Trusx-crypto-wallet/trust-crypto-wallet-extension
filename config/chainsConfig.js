// config/chainsConfig.js
// ------------------------------------------------------------
// Centralised chain metadata for the multi‑chain wallet.
// ------------------------------------------------------------
// NOTE: Only import from the five sanctioned config modules.

import { TOKEN_CONFIGS }        from './tokenConfig.js';
import { WEB3_PROVIDER_CONFIGS } from './web3providerConfig.js';
import { GAS_CONFIGS }          from './gasConfig.js';
import { DAPP_CONFIGS }         from './dappConfig.js';
import { BROADCAST_CONFIGS }    from './broadcastConfig.js';
